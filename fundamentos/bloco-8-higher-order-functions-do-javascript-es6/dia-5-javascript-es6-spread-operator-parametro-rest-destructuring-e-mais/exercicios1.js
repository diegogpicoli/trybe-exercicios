...
//   rectangleArea(...rectangles) // altere a chamada da função rectangleArea
...
const sum = (...arg) => {
    return arg.reduce((acc, numero) => acc + numero)
}
...
//     if (bornIn > 1900 && nationality === 'Australian'){
//       filtro.push(element)
//     }
//   });
//   return filtro
...
const filterPeople = (array) => {
    const novoArray = array.filter(({ nationality, bornIn }) => {
